...
#include <string.h>
const char *fractal_module_kind_string(fractal_module_kind k) { static const char *n[]={"formula","numeric","compute","refinement","scheduler","raster","encoder","memory","telemetry","platform","artifact_sink"}; return (unsigned)k<FRACTAL_MODULE_KIND_COUNT?n[k]:NULL; }
