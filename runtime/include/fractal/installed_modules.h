...
typedef struct fractal_runtime_selection { const char *formula,*numeric,*compute,*refinement,*scheduler,*raster,*encoder,*memory,*telemetry,*platform,*analyzer; fractal_analysis_output_mode analysis_mode; } fractal_runtime_selection;
