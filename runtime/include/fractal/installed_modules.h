...
typedef struct fractal_runtime_selection { const char *formula,*numeric,*compute,*refinement,*scheduler,*raster,*encoder,*memory,*telemetry,*platform,*analyzer; fractal_analysis_output_mode analysis_mode; size_t analyzer_count; const char *analyzers[FRACTAL_ANALYZER_CHAIN_MAX]; } fractal_runtime_selection;
