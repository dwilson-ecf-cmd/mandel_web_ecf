...
/* Engineering record of source-defined proof-sheet fields; no field asserts that
 * Mandelbrot iteration satisfies CDC. CDC reference: CDC-CONFIG-001, CDC-CERT-001. */
